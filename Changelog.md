# AclPermalink Changelog

We would like to think our many {file:Contributors contributors} for
suggestions, ideas and improvements to AclPermalink.
...
* Added set_acl_permalink method to Globalize module (Norman Clarke).

* autoload AclPermalink::Slug; previously this class was not accessible from
...
* to_param just calls super when no acl_permalink is present, to keep the model's
  default behavior. (Andrew White)

* AclPermalink can now properly sequence slugs that end in numbers even when a
...
* Allow AclPermalink to be extended or included (Norman Clarke)
...
This is a complete rewrite of AclPermalink, and introduces a smaller, faster and
