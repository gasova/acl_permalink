...
=end
  module Scoped
    ...
    # Sets up behavior and configuration options for AclPermalink's scoped slugs
    # feature.
    def self.included(model_class)
      model_class.instance_eval do
        raise "AclPermalink::Scoped is incompatibe with AclPermalink::History" if self < History
        include Slugged unless self < Slugged
        acl_permalink_config.class.send :include, Configuration
    ...
    module Configuration
      ...
      # {AclPermalink::Base#acl_permalink} refers to a relation, and if so, returns
    ...
    # This module overrides {AclPermalink::SlugGenerator#conflict} to consider
    ...
    module SlugGenerator
      ...
      def conflict
        columns = acl_permalink_config.scope_columns
